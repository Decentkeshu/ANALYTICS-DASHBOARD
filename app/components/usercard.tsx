...
export default function Usercard({ label, value, change, icon: Icon }: users) {
  return (
    <div style={{ background: "var(--bg)", color: "var(--text)" }} className="relative bg-gray-100 rounded-lg p-4 flex flex-col gap-1 hover:bg-purple-100 cursor-pointer border border-gray-200 flex-1">
