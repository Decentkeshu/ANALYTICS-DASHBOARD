...
import { getTotalOverview } from "../services/analyticsservices";
...
export default function Totaloverview() {
  ...
  useEffect(() => {
    const fetchOverview = async () => {
      try {
        const { status, data } = await getTotalOverview();

        console.log("TotalOverview status:", status);
        console.log("TotalOverview data:", data);
